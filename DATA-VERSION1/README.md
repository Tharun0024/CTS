...
```json
{
  ...
  "procedure": { "code": "27447", "description": "Total knee arthroplasty (TKA), right knee" },
  "clinical_facts": [ "Evidence of type DIAGNOSIS..." ],
  "policy_questions": [
    "Is there a primary diagnosis of knee osteoarthritis?",
    "Is there radiographic evidence of joint space narrowing?",
    "Has the patient failed at least 12 weeks of conservative treatment?",
    "Is the procedure recommended by an orthopedic surgeon?"
  ]
}
```
