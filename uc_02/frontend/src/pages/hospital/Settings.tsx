...
export function Settings() {
  ...
  const tabs = [
    ...
    { id: 'hospital', name: 'Hospital Details', icon: Building, desc: 'Org info & NPI' },
  ...
  return (
    <div className="max-w-6xl mx-auto w-full animate-fade-in-up space-y-6 pb-10">
      <div>
        ...
        <p className="text-sm text-slate-500 font-medium mt-1">Manage your account, hospital organization, and security settings</p>
      </div>
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        <Card className="flex-1 overflow-hidden flex flex-col">
          <CardContent className="p-6 sm:p-8 flex-1">
            ...
            {activeTab === 'hospital' && (
              <div className="space-y-8 animate-fade-in-up">
                <h2 className="text-lg font-bold text-slate-900 mb-6 flex items-center gap-2">Hospital Details</h2>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div className="sm:col-span-2">
                    <label className={LABEL}>Hospital Name</label>
                    <input type="text" defaultValue="City General Hospital" className={FIELD_INPUT} />
                  </div>
                  <div>
